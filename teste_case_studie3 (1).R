...
#importação dos nomes dos filmes
...
# Tentando Pegar os nomes e gêneros dos filmes de movies e trazer pra data
...
#histograma da distribuição das classificações/ratings
...
# ETAPA 04 -  Lista de top 5 recomendações para usuários com base em cada modelo proposto ----
    ...
    rec.list_mov <- as.data.frame(as(rec.items, "list"))[ ,1:10] #Col= usuário e raws = recomendações
